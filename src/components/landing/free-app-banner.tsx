...
export function FreeAppBanner() {
  return (
    <div className="bg-linear-to-r from-vos-accent via-[#EAC75E] to-vos-accent text-vos-primary py-3.5 px-4 text-center text-base md:text-lg font-bold relative overflow-hidden shadow-xl z-50">
