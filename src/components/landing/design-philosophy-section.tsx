export function DesignPhilosophySection() {
  return (
    <section className="relative overflow-hidden w-full py-section-gap bg-linear-to-tr from-vos-muted/80 via-vos-bg-light to-vos-muted/80 bg-200% animate-gradient-shift">
      <div
      ...
      />
      <div className="container mx-auto px-4 md:px-6 max-w-(--breakpoint-lg) animate-fade-in-up">
